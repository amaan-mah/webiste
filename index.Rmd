...
The [previous studies](https://pubmed.ncbi.nlm.nih.gov/26449855/) have observed the Cadmium concentrations in water and soil, and did not find a significant correlation with the blood Cadmium levels. However, there were no measurements of Cadmium in the air and considering that the Durham county has quite a few industries, it is worth checking the EPA data for emissions in general.
